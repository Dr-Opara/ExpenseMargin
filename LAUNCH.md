...
### Stripe
Create recurring monthly prices for Business ($39) and Pro ($99), configure the corresponding Vercel environment variables, and point the production webhook to:
...
7. Test Business and Pro Stripe checkout and customer portal.
