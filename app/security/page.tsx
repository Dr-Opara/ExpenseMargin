...
const controls = [
  ...
  ["Auditable activity", "Sensitive product, billing, settings, invoice, and data-export events are recorded in tenant-scoped audit history."],
...
export default function SecurityPage() {
  return <div className="container">
    <nav className="landing-nav"><Brand /><div className="nav-actions"><Link className="btn" href="/pricing">Pricing</Link><Link className="btn primary" href="/signup">Start free</Link></div></nav>
    <section className="page" style={{paddingLeft:0,paddingRight:0}}>
      ...
      <section className="panel"><div style={{padding:20,lineHeight:1.7}}><strong>Security reporting:</strong> Report suspected vulnerabilities through the official ExpenseMargin contact channel published with the production domain. Do not include passwords, API keys, or sensitive invoice data in an initial report.</div></section>
    </section>
  </div>;
}
